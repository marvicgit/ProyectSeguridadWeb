...
public interface IUsuarioRepo extends JpaRepository<Usuario, Integer> {
	...
	@Query(value = "select new aate.gob.pe.DTO.ReporteDTO(s.SISCOD, s.SISNOM, u.USULOG, r.ROLNOM, u.USUEST)  from UserSisRolFuncionalidad usr inner join usr.rol r inner join usr.usuario u inner join Sistema s on s.SISCOD = usr.SISCOD")
